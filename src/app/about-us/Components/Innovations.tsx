...
export default function Innovations(props: any) {
  ...
  return (
    <section className='weekday-component static-component' id='who-are-we'>
      {userDetails?.data.attributes.innovation.data.attributes.Innovation == null ? null : (
        <div className='container'>
          <div className='row align-items-center'>
            <div className='col-md-5'>
              <div className='quote-image'>
                {userDetails?.data.attributes.innovation.data.attributes.Innovation[0].Images.data == null ? null : (
                  <img
                    src={
                      strapi.strapihost +
            ...
            <div className='col-md-7'>
              <div className='weekday-desc'>
                {userDetails?.data.attributes.innovation.data.attributes.Innovation[0].SubTitle == null ? null : (
                  <span className='tag-line'>
                    {userDetails?.data.attributes.innovation.data.attributes.Innovation[0].SubTitle}
                  </span>
                )}
                {userDetails?.data.attributes.innovation.data.attributes.Innovation[0].Title == null ? null : (
                ...
                {userDetails?.data.attributes.innovation.data.attributes.Innovation[0].Body == null ? null : (
                  <RichText
